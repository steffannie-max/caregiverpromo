    ...
    <div className="relative">
      ...
      <div className="pt-16 relative">
        ...
        {slideVideos[currentSlide] && hasStarted && currentSlide !== 5 && (
          <div className="fixed bottom-28 right-6 z-40 w-64 h-36 rounded-lg overflow-hidden shadow-2xl border-2 border-primary">
            <video
              ref={pipVideoRef}
              key={currentSlide}
                ...
                <div className="space-y-8">
                  ...
                  <div className="max-w-5xl mx-auto">
                    {interviewVideos.section1 ? (
                      <div className="aspect-video bg-muted rounded-lg overflow-hidden shadow-2xl border-4 border-primary">
                        <video
                          controls
                      ...
                      <div className="p-8 bg-muted/50 rounded-lg text-center border-2 border-dashed border-border">
